...
import com.thanics.andrew.halocontrol.Stereo3DFlightScene.VrStereoActivity;
...
public class VrMainActivity extends GvrActivity {
    ...
    private MainSceneRenderer renderer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        renderer = new MainSceneRenderer(this, gvrView);
        renderer.mainMenuView.setVrIconClickListener(
                new OnClickListener() {
                    @Override
        ...
        renderer.mainMenuView.setStereoStreamClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(VrMainActivity.this, StereoFlightActivity.class));
                        finish();
                    }
                });
