    ...
    private class Renderer implements GvrView.StereoRenderer {
        ...
        public Renderer(ViewGroup parent) {
            Pair<SceneRenderer, VideoUiView> pair
                    = SceneRenderer.createForVR(VrMainActivity.this, parent);
            scene = pair.first;
            uiView = pair.second;
            ...
            uiView.setStereoStreamClickListener(

                    new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            startActivity(new Intent(getIntent()).setClass(getApplicationContext(), VrStereoActivity.class));
                            finish();
                        }
                    });
        }
